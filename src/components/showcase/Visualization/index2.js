import { memo, useRef, forwardRef, createRef, Suspense, useState } from "react";
...
const Visualization = () => {
  ...
  return (
    <Canvas shadows camera={{ position: [0, 0, 5], fov: 60 }} style={{backgroundColor: lerp("#000000", "#ffffff", 0)}}>
...
const Character = forwardRef((_, ref) => {
  ...
  return (
    <Center top ref={ref} position={[0, 0, 0]}>
...
const Cypher = forwardRef((_, ref) => {
  ...
  return (
    ...
    // </Center>
    <Center ref={ref}>
      {/* <Box args={[0.86, 0.016, 0.54]} castShadow>
