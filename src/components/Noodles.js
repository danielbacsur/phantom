...
import { LayerMaterial, Base, Depth, Fresnel, Noise, Gradient, Color } from 'lamina/vanilla'

const black = new THREE.Color('#000000').convertSRGBToLinear()
...
function Noodle() {
  ...
  console.log(nodes)
  const [geometry] = useState(() => nodes[`imagetostl_mesh`].geometry)
  ...
  return (
    <Float position={position} speed={speed} rotationIntensity={10} floatIntensity={40} dispose={null}>
      <mesh scale={0.02} geometry={geometry} material={material} />
    </Float>
  )
}
