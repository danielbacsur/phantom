...
import { useGLTF, Stage, Grid, OrbitControls, Environment, Box } from '@react-three/drei'
...
export default function App() {
  return (
    ...
    <Canvas gl={{ logarithmicDepthBuffer: true }} shadows camera={{ position: [-15, 0, 10], fov: 25 }}>
      ...
      <Grid renderOrder={-1} position={[0, -1.85, 0]} infiniteGrid cellSize={0.5} cellThickness={0.6} sectionSize={3.3} sectionThickness={1.5} sectionColor={[0.5, 0.5, 10]} fadeDistance={30} />
      <OrbitControls autoRotate autoRotateSpeed={0.05} enableZoom={false} makeDefault minPolarAngle={Math.PI / 4} maxPolarAngle={Math.PI / 4} />
