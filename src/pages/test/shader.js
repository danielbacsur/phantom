...
export const App = () => (
  <Canvas shadows camera={{ position: [-4.5, 0, 12], fov: 35 }} style={{
    position: "absolute",
    top: 0,
    left: 0,
    bottom: 0,
    ...
    <group position={[0.5, -1.5, 0]}>
      ...
      <Caustics color="hotpink" lightSource={[5, 5, -10]} worldRadius={0.01} ior={1.1} intensity={0.01}>
        <mesh castShadow position={[2, 0.5, 2]}>
          ...
          <MeshTransmissionMaterial attach="material-0" resolution={768} thickness={0.3} anisotropy={1} chromaticAberration={0.1} />
