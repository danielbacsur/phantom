...
import { useIntersect, Image, Html } from '@react-three/drei'
...
const Titles = () => {
  ...
  // return <Scroll html>
  //   <div className='h-screen grid grid-cols-12 place-items-center'>
  //     <div className='col-span-4 text-[7vw]'>
  //       cypher
  //     </div>
  ...
  //     </div>
  //   </div>
  //   {/* <h1 className='text-[10vw]' style={{ position: 'absolute', top: `100vh`, right: '20vw', fontSize: '25em', transform: `translate3d(0,-100%,0)` }}>all</h1> */}
  //   <h1 className='text-[10vw]' style={{ position: 'absolute', top: '180vh', left: '10vw' }}>hail</h1>
  //   <h1 className='text-[10vw]' style={{ position: 'absolute', top: '260vh', right: '10vw' }}>thee,</h1>
  //   <h1 className='text-[10vw]' style={{ position: 'absolute', top: '350vh', left: '10vw' }}>thoth</h1>
  //   <h1 className='text-[10vw]' style={{ position: 'absolute', top: '450vh', right: '10vw' }}>
  //     her
  //     <br />
  //     mes.
  //   </h1>
